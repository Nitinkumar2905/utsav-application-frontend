...
const Footer = () => {
    return (
        <>
            <div className='bg-gradient-to-bl from-blue-100 to-red-100 flex items-end lg:h-[60vh] w-full'>
                    ...
                    <div className='hidden xl:flex space-y-5 flex-col items-start justify-center w-[90%]'>
                        ...
                        <div className='w-full flex flex-col items-start space-y-4'>
                            <ul className='flex flex-col lg:flex-row md:space-x-5'>
                                <Link className='md:text-lg md:pr-2  md:border-[1px] md:border-y-0 md:border-l-0 md:border-r-black underline font-medium decoration-red-600' style={{ fontFamily: 'sans-serif' }} to="/product">Home</Link>
                                <Link className='md:text-lg md:pr-2  md:border-[1px] md:border-y-0 md:border-l-0 md:border-r-black underline font-medium decoration-red-600' style={{ fontFamily: 'sans-serif' }} to="/product">Product</Link>
                                <Link className='md:text-lg md:pr-2  md:border-[1px] md:border-y-0 md:border-l-0 md:border-r-black underline font-medium decoration-red-600' style={{ fontFamily: 'sans-serif' }} to="/product">Services</Link>
                                <Link className='md:text-lg md:pr-2  md:border-[1px] md:border-y-0 md:border-l-0 md:border-r-black underline font-medium decoration-red-600' style={{ fontFamily: 'sans-serif' }} to="/product">Features</Link>
                                <Link className='md:text-lg md:pr-2  md:border-[1px] md:border-y-0 md:border-l-0 md:border-r-black underline font-medium decoration-red-600' style={{ fontFamily: 'sans-serif' }} to="/product">About</Link>
                                <Link className='md:text-lg md:pr-2  underline font-medium decoration-red-600' style={{ fontFamily: 'sans-serif' }} to="/product">Contact</Link>
                            </ul>
                    ...
                    <div className='w-[100%] flex justify-between h-full items-center'>
                        <div className='w-fit mx-auto md:w-[100%] space-y-6'>
                            <div className='w-[100%] space-y-1'>
                                ...
                                <div className='space-y-1'>
                                    ...
                                    <div className='flex items-center space-x-4'>
                                        ...
                                        <span className='cursor-pointer text-sky-600 underline font-medium text-lg' style={{ fontFamily: 'sans-serif' }}>utsav@gmail.com</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className='flex space-y-6 flex-col'>
                                ...
                                <span className='flex md:hidden font-medium text-lg ' style={{ fontFamily: 'sans-serif' }}>UTSAV &#169; 2023 - All rights reserved</span>
                            </div>
                        </div>
                        {/* about company */}
